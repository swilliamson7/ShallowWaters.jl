...
# Does NOT remove ghost points at end 
function time_integration_withreturn(S::ModelSetup{T,Tprog}) where {T<:AbstractFloat,Tprog<:AbstractFloat}
...
# Returns nothing, no feedback lines
function time_integration_nofeedback(S::ModelSetup{T,Tprog}) where {T<:AbstractFloat,Tprog<:AbstractFloat}
...
# Includes a cost function evaluation and checkpointing
