...
function cost_eval(param_guess)
    ...
    # aiming to have data roughly every day
    data_steps = 225:225:81910
    data = energy_high_resolution[225*grid_scale:225*grid_scale:81910*grid_scale]

    S = ShallowWaters.run_setup(Ndays = 365,
        nx = 128,
