...
function cost_eval(param_guess)
    ...
    S = ShallowWaters.run_setup(Ndays = 90,
        nx = 128,
...
jldsave("gamma_tuned_90days_dailydata_averagedenergy_031824.jld2"; res.minimizer)
...
plot!(x2, e_hr, dpi=300, label="7.5km", legend=:bottomleft)
xlabel!("Days")
